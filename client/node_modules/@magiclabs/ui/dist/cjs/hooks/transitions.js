    ...
    return {
        withVariants: (variants) => ({
            use: (targets) => {
                ...
                return React.useCallback((custom = {}) => ({ custom, variants, initial, animate, exit }), [
                    initial,
                    animate,
                    exit,
                ]);
...
exports.createFramerTransition = createFramerTransition;
exports.useFade = useFade;
exports.useScale = useScale;
exports.useScaleIn = useScaleIn;
exports.useScaleOut = useScaleOut;
