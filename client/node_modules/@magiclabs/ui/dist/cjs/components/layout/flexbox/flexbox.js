...
const FlexItem = /* @__PURE__ */ forwardRefWrapper.forwardRefWrapper('FlexItem', (props, externalRef) => {
    const { className, inline } = props, otherProps = _tslib.__rest(props, ["className", "inline"]);
    return (React__default['default'].createElement(FlexLayout, Object.assign({ className: classNames.classNames([flexbox.default.FlexItem, className, inline && flexbox.default.inlineItem]) }, otherProps, { ref: externalRef })));
});
// -------------------------------------------------------------------------- //
const FlexContainer = /* @__PURE__ */ forwardRefWrapper.forwardRefWrapper('FlexContainer', (props, externalRef) => {
    const { className, inline } = props, otherProps = _tslib.__rest(props, ["className", "inline"]);
    return (React__default['default'].createElement(FlexLayout, Object.assign({ className: classNames.classNames([flexbox.default.FlexContainer, flexbox.default.FlexItem, className, inline && flexbox.default.inlineContainer]) }, otherProps, { ref: externalRef })));
});
const FlexRow = /* @__PURE__ */ forwardRefWrapper.forwardRefWrapper('Row', (props, externalRef) => {
...
const FlexColumn = /* @__PURE__ */ forwardRefWrapper.forwardRefWrapper('Column', (props, externalRef) => {
    const { reverse, horizontal, vertical } = props, otherProps = _tslib.__rest(props, ["reverse", "horizontal", "vertical"]);
