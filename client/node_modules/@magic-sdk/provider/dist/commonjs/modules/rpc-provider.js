...
var RPCProviderModule = /** @class */ (function (_super) {
    tslib_1.__extends(RPCProviderModule, _super);
    ...
    RPCProviderModule.prototype.sendAsync = function (payload, onRequestComplete) {
        ...
        if (Array.isArray(payload)) {
            this.transport
                ...
                onRequestComplete(null, batchResponse.map(function (response) { return (tslib_1.__assign(tslib_1.__assign({}, response.payload), { error: response.hasError ? new sdk_exceptions_1.MagicRPCError(response.payload.error) : null })); }));
            });
        }
        else {
