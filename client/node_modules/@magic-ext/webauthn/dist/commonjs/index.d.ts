...
export declare class WebAuthnExtension extends Extension.Internal<'webauthn', any> {
    ...
    updateInfo(configuration: UpdateWebAuthnInfoConfiguration): import("magic-sdk").PromiEvent<any[], {
        done: (result: any[]) => void;
        error: (reason: any) => void;
        settled: () => void;
    }>;
    unregisterDevice(id: string): import("magic-sdk").PromiEvent<any, {
        done: (result: any) => void;
        error: (reason: any) => void;
        settled: () => void;
    }>;
    registerNewDevice(nickname?: string): Promise<string | null>;
    getMetadata(): import("magic-sdk").PromiEvent<any[], {
        done: (result: any[]) => void;
        error: (reason: any) => void;
        settled: () => void;
    }>;
